/**
 * PackingSlipDemo v7 — Compressed card + tight pagination (auto-suppresses continuation hints when content fits):
 *
...
import { PackingSlipDocumentV7 as PackingSlipDocument, type PackingSlipData } from '../../../components/PackingSlipDocument_v7';
 ...
 * ════════════════════════════════════════════════════════════════ */
export default function PackingSlipDemoV7() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: 'var(--sp-10) 0', gap: 'var(--sp-4)' }}>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div className="text-[length:var(--text-xs)] text-[color:var(--gray-400)] mt-1">
          v7: compressed card (180×110 thumb) · tight pagination (gap-aware bin-packing, auto hide continuation hints when fits)
        </div>
      </div>
