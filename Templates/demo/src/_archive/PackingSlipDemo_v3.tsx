/**
 * PackingSlipDemo v3 — Demonstrates 3 Packing Slip variants:
 *
...
import { PackingSlipDocumentV3 as PackingSlipDocument, type PackingSlipData } from '../../components/PackingSlipDocument_v3';
 ...
 * ════════════════════════════════════════════════════════════════ */
export default function PackingSlipDemoV3() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: 'var(--sp-10) 0', gap: 'var(--sp-4)' }}>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div className="text-[length:var(--text-xs)] text-[color:var(--gray-400)] mt-1">
          3 variants: International (split billing) · Domestic · Partial Shipment
        </div>
      </div>
