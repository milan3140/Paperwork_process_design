...
function buildPdfSections(
                ...
                {(() => {
                  ...
                  return (
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                      {/* Part name */}
                      <div style={{ fontSize: '11px', fontWeight: 600, color: 'var(--gray-900)', padding: '10px 12px 6px 12px', textAlign: 'center' }}>
                        {part.name}
                      </div>
                      {/* Thumbnail */}
                      ...
                      {details.length > 0 && (
                        <div className="text-[length:var(--doc-text-secondary,9px)] text-[color:var(--gray-500)]" style={{ padding: '0 12px 10px 12px', textAlign: 'center' }}>
                          {details.join(' · ')}
                        </div>
                      )}
                    </div>
                ...
                {rawPart.dimensions && (rawPart.dimensions.length > 0 || rawPart.dimensions.width > 0 || rawPart.dimensions.height > 0) && (() => {
                  ...
                  return (
                    <div style={{ alignSelf: 'stretch' }}>
                      ...
                      <div style={{ fontSize: '8.5px', color: 'var(--gray-400)', textAlign: 'center', paddingTop: '4px', paddingBottom: '4px' }}>
  ...
  sections.push({
    ...
    content: (
      <div>
        <SectionLabel className="!border-b !border-[var(--color-primary)]">
          <span className="text-[color:var(--color-primary)]">How to Proceed</span>
        </SectionLabel>
        <ol style={{ margin: '8px 0 0 0', paddingLeft: '16px', listStyleType: 'decimal' }}>
          {proceedSteps.map((step, i) => (
            <li key={i} className="text-[length:var(--doc-text-body,10px)] text-[color:var(--gray-600)]" style={{ marginBottom: i < proceedSteps.length - 1 ? '4px' : 0 }}>
              {step}
            </li>
          ))}
        </ol>
        {isPia && (
          <div className="text-[length:var(--doc-text-secondary,9px)] text-[color:var(--gray-400)]" style={{ marginTop: '6px' }}>
