/**
 * PackingSlipDemo v5 — Per-part document checklist (0–3 items), compacted thumbnail:
 *
...
import { PackingSlipDocumentV5 as PackingSlipDocument, type PackingSlipData } from '../../../components/PackingSlipDocument_v5';
import { DownloadPdfButton } from '../DownloadPdfButton';
import { MODEL_SHOT_1 as thumb1, MODEL_SHOT_2 as thumb2 } from '../../../components/_assets';

const THUMBS = [thumb1, thumb2];

/** Attach rotating 3D thumbnails to every item. */
 ...
 * ════════════════════════════════════════════════════════════════ */
export default function PackingSlipDemoV5() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: 'var(--sp-10) 0', gap: 'var(--sp-4)' }}>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div className="text-[length:var(--text-xs)] text-[color:var(--gray-400)] mt-1">
          v5: per-part doc checklist 0–3 items · compact thumbnail 140×140 · tighter card body
        </div>
      </div>
