/**
 * PackingSlipDemo v8 — v7 with mid-gray header/primary:
 *
...
import { PackingSlipDocumentV8 as PackingSlipDocument, type PackingSlipData } from '../../../components/PackingSlipDocument_v8';
 ...
 * ════════════════════════════════════════════════════════════════ */
export default function PackingSlipDemoV8() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: 'var(--sp-10) 0', gap: 'var(--sp-4)' }}>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div className="text-[length:var(--text-xs)] text-[color:var(--gray-400)] mt-1">
          v8: mid-gray header (#595959) — softer visual weight
        </div>
      </div>
