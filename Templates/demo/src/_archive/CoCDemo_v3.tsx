/**
 * CoCDemo_v3 — Certificate of Conformance v2 demo
 *
 ...
 * ════════════════════════════════════════════════════════════════ */
const sampleInternational: CoCDataV3 = {
  cocId: 'COC-2026-0031',
  date: 'April 20, 2026',
 ...
 * ════════════════════════════════════════════════════════════════ */
const sampleDomestic: CoCDataV3 = {
  cocId: 'COC-2026-0035',
  date: 'May 5, 2026',
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: 'var(--sp-10) 0', gap: 'var(--sp-4)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-8)' }}>
        <CoCDocumentV3 data={sampleInternational} />
        <CoCDocumentV3 data={sampleDomestic} />
      </div>
