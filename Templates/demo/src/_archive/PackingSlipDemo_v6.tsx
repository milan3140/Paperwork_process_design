/**
 * PackingSlipDemo v6 — Dimensions as separate cell on right, square thumbnail:
 *
...
import { PackingSlipDocumentV6 as PackingSlipDocument, type PackingSlipData } from '../../../components/PackingSlipDocument_v6';
 ...
 * ════════════════════════════════════════════════════════════════ */
export default function PackingSlipDemoV6() {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: 'var(--sp-10) 0', gap: 'var(--sp-4)' }}>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div className="text-[length:var(--text-xs)] text-[color:var(--gray-400)] mt-1">
          v6: dimensions as separate right-column cell · square thumbnail (1:1 aspect)
        </div>
      </div>
