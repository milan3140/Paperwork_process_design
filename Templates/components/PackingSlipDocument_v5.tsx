/**
 * PackingSlipDocument v5 — Shipment manifest for CNC machined parts
 *
 * v5 changes from v4:
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex' }}>
        ...
        {/* Image — thumbnail 210×160 + dims/weight below (v5: dims stays under thumbnail) */}
        <div style={{
          width: 210,
          flexShrink: 0,
          borderRight: '1px solid var(--gray-150)',
          background: '#FFFFFF', /* v5: thumbnail + dims on white to emphasize the image */
          display: 'flex',
...
export const PackingSlipDocumentV5 = React.forwardRef<HTMLDivElement, PackingSlipDocumentProps>(
  function PackingSlipDocumentV5({ data }, ref) {
...
export default PackingSlipDocumentV5;
