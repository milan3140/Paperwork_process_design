          ...
          {(() => {
            ...
            return (
              <div style={{
                padding: '6px var(--sp-3)',
                borderTop: '1px solid var(--gray-150)',
                background: '#FAFAFA', /* print-safe: no hue → no CMYK color shift (was var(--gray-50) #F7F6FB) */
              }}>
...
export const PackingSlipDocumentV11 = React.forwardRef<HTMLDivElement, PackingSlipDocumentProps>(
  function PackingSlipDocumentV11({ data }, ref) {
...
export default PackingSlipDocumentV11;
