 ...
 * |------|-----------|----------|--------------------------|
 * | data | CoCDataV3 | yes      | Complete CoC data object |
 *
 * ─── Usage ──────────────────────────────────────────────────────────────────
 *
 *   const ref = useRef<HTMLDivElement>(null);
 *   <CoCDocumentV3 ref={ref} data={cocData} />
 */
...
export interface CoCPartEntryV3 {
...
export interface CoCComplianceItemV3 {
...
export interface CoCDataV3 {
  ...
  /* ── Parts ── */
  parts: CoCPartEntryV3[];

  /* ── Shipment ── */
  countryOfOrigin?: string;

  /* ── Compliance ── */
  compliance: CoCComplianceItemV3[];
...
export const CoCDocumentV3 = React.forwardRef<HTMLDivElement, CoCDocumentV3Props>(
  function CoCDocumentV3({ data }, ref) {
    ...
    return (
      <div ref={ref} data-comp="CoCDocumentV3">
        <PaginatedDocument
