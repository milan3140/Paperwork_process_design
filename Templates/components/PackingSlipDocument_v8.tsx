/**
 * PackingSlipDocument v8 — v7 with mid-gray header/primary (softer visual weight)
 *
 * v7 changes from v5:
    ...
    <div style={{
      ...
      <div style={{ display: 'flex' }}>
        ...
        <div style={{
          ...
          background: '#FFFFFF', /* v8: thumbnail + dims on white to emphasize the image */
          display: 'flex',
          ...
          <div style={{
            ...
            <div style={{ fontSize: 'var(--doc-text-body)', fontWeight: 700, color: 'var(--gray-900)', whiteSpace: 'nowrap' }}>
...
export const PackingSlipDocumentV8 = React.forwardRef<HTMLDivElement, PackingSlipDocumentProps>(
  function PackingSlipDocumentV8({ data }, ref) {
    ...
    return (
      <div ref={ref} data-comp="PackingSlipDocument" data-variant="v8">
        <PaginatedDocument
...
export default PackingSlipDocumentV8;
