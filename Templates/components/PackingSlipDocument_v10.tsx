/**
 * PackingSlipDocument v10 — v9 + all body text in solid black.
 *
...
function PartCard({ item, orderId, defaultDocuments }: { item: PackingSlipItem; orderId: string; defaultDocuments?: string[] }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        display: 'grid',
        gridTemplateColumns: 'calc(140px - var(--sp-3)) 1fr',
        alignItems: 'baseline',
      ...
      <div style={{ display: 'flex' }}>
        ...
        {/* Image — compact thumbnail 180×110 + dims/weight below (v5: tuned to fit 3 cards per page) */}
        <div style={{
          width: 180,
          flexShrink: 0,
          borderRight: '1px solid var(--gray-150)',
          background: '#FFFFFF', /* v9: thumbnail + dims on white to emphasize the image */
          display: 'flex',
...
export const PackingSlipDocumentV10 = React.forwardRef<HTMLDivElement, PackingSlipDocumentProps>(
  function PackingSlipDocumentV10({ data }, ref) {
      ...
      sections.push({
        ...
        content: (
          <div data-el="PackingSlipDocument-comments">
            <SectionLabel className="!text-[color:var(--gray-900)] !text-[10px] !font-normal">Notes</SectionLabel>
            <p
    ...
    sections.push({
      ...
      content: (
        <div data-el="PackingSlipDocument-items">
          <SectionLabel className="!text-[color:var(--gray-900)] !text-[10px] !font-normal">
    ...
    return (
      <div ref={ref} data-comp="PackingSlipDocument" data-variant="v10">
        <PaginatedDocument
            ...
            <div data-el="PackingSlipDocument-titleRow" className="flex items-start justify-between" style={{ marginBottom: 8 }}>
              <div>
                ...
                >
                  ...
                  <span className="text-[color:var(--gray-900)]" style={{ fontSize: 22, fontWeight: 300, marginLeft: 24 }}>
                    Page {pageNum} of {totalPages}
                  </span>
                </div>
                <div className="flex items-center gap-[var(--sp-3)] mt-[var(--doc-sp-half)]">
                  <span className="font-light text-[color:var(--gray-900)] tracking-[var(--doc-tracking-title)]" style={{ fontSize: 18 }}>
                    #{displaySlipId}
                  </span>
...
export default PackingSlipDocumentV10;
