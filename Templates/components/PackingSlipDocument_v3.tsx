/**
 * PackingSlipDocument v3 — Shipment manifest for CNC machined parts
 *
  ...
  return (
    <div style={{ display: 'flex', gap: 'var(--sp-3)', alignItems: 'flex-start' }}>
      ...
      <div>
        ...
        <div className="text-[color:var(--gray-600)] leading-[1.5]" style={{ fontSize: 12 }}>
...
function InfoGrid({ items }: { items: { label: string; value: string }[] }) {
  ...
  return (
    <div
      className="grid"
      style={{ gridTemplateColumns: '76px 1fr', columnGap: 'var(--sp-3)', rowGap: 'var(--sp-2)', alignItems: 'center' }}
    >
      {items.map((item, i) => (
        <React.Fragment key={i}>
          ...
          <span className="font-semibold text-[color:var(--gray-900)]" style={{ fontSize: 13, lineHeight: 1 }}>
            {item.value}
          </span>
        </React.Fragment>
      ))}
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex' }}>
        ...
        {/* Image — 150×150 square thumbnail + dims/weight below */}
        <div style={{
          width: 200,
          flexShrink: 0,
          ...
          <div style={{
            ...
            <div style={{ fontSize: 'var(--doc-text-body)', fontWeight: 700, color: 'var(--gray-900)' }}>
              {convertDimsToInch(item.dims)}{' · '}{convertWeightToLb(item.unitWeight)}
            </div>
            <div style={{ fontSize: 'var(--doc-text-body)', fontWeight: 300, color: 'var(--gray-500)' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          {/* Required documents checklist — item.documents overrides defaultDocuments */}
          {((item.documents ?? defaultDocuments)?.length ?? 0) > 0 && (
            <div style={{
              padding: '14px var(--sp-3)',
              borderTop: '1px solid var(--gray-150)',
              background: '#F5F5F5', /* print-safe: no hue → no CMYK color shift (was var(--gray-50) #F7F6FB) */
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                {(item.documents ?? defaultDocuments ?? []).map((name, i) => (
                  <div key={i} style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
                    ...
                    <span style={{ fontSize: 15, color: 'var(--gray-800)' }}>
                      {name}
                    </span>
                  </div>
                ))}
...
export const PackingSlipDocumentV3 = React.forwardRef<HTMLDivElement, PackingSlipDocumentProps>(
  function PackingSlipDocumentV3({ data }, ref) {
      ...
      content: (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-3)' }}>
          ...
          <div data-el="PackingSlipDocument-titleRow" className="flex items-start justify-between">
            <div>
              ...
              <div className="flex items-center gap-[var(--sp-3)] mt-[var(--doc-sp-half)]">
                <span className="font-semibold text-[color:var(--gray-400)] tracking-[var(--doc-tracking-title)]" style={{ fontSize: 14 }}>
                  #{displaySlipId}
                </span>
            ...
            <DocumentMeta items={metaItems} labelFontSize={11} valueFontSize={14} />
          </div>
          ...
          <div data-el="PackingSlipDocument-shipFrom">
            ...
            <div className="text-[color:var(--gray-600)] leading-[1.5]" style={{ fontSize: 11 }}>
          ...
          <div
            ...
            className="grid grid-cols-2 gap-[var(--sp-6)] pt-[var(--sp-2)] border-t border-[var(--gray-150)]"
          >
          ...
          >
            {isMerged ? (
              ...
              <>
                ...
                <div className="border-t border-[var(--gray-150)]" />
                <AddressEntry label="Ship To" party={data.shipTo} />
              </>
            )}
          </div>
      ...
      sections.push({
        ...
        content: (
          <div data-el="PackingSlipDocument-comments">
            ...
            <p
              className="font-bold text-[color:var(--gray-700)] mt-[var(--doc-sp-1-5)] leading-[1.6]"
...
export default PackingSlipDocumentV3;
