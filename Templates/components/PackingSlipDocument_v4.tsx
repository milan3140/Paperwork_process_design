/**
 * PackingSlipDocument v4 — Shipment manifest for CNC machined parts
 *
 * v4 changes from v3:
...
export const PackingSlipDocumentV4 = React.forwardRef<HTMLDivElement, PackingSlipDocumentProps>(
  function PackingSlipDocumentV4({ data }, ref) {
      ...
      content: (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sp-1)' }}>
          ...
          <div data-el="PackingSlipDocument-titleRow" className="flex items-start justify-between">
            <div>
              <div className="text-[length:var(--doc-text-title)] font-bold text-[color:var(--color-primary)] tracking-[var(--doc-tracking-title)] leading-none">
                Packing Slip
              </div>
            ...
            <div style={{ ['--sp-1' as any]: '2px' } as React.CSSProperties}>
...
export default PackingSlipDocumentV4;
