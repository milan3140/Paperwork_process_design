...
export const PackingSlipDocumentV12 = React.forwardRef<HTMLDivElement, PackingSlipDocumentProps>(
  function PackingSlipDocumentV12({ data }, ref) {
...
export default PackingSlipDocumentV12;
