/**
 * PackingSlipDocument v7 — Shipment manifest for CNC machined parts (compressed + tight-pagination)
 *
 * v7 changes from v5:
    ...
    <div style={{
      ...
      <div style={{ display: 'flex' }}>
        ...
        <div style={{
          ...
          background: '#FFFFFF', /* v7: thumbnail + dims on white to emphasize the image */
          display: 'flex',
...
export const PackingSlipDocumentV7 = React.forwardRef<HTMLDivElement, PackingSlipDocumentProps>(
  function PackingSlipDocumentV7({ data }, ref) {
...
export default PackingSlipDocumentV7;
