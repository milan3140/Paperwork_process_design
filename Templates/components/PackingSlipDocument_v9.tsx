/**
 * PackingSlipDocument v9 — v7 with brand primary (InstaVoxel purple #2E0D77) header
 *
 * v7 changes from v5:
...
function InfoGrid({ items }: { items: { label: string; value: string }[] }) {
  ...
  return (
    ...
    >
      {items.map((item, i) => (
        <React.Fragment key={i}>
          <span className="text-[color:var(--gray-400)] uppercase tracking-[var(--doc-tracking-label)]" style={{ fontSize: 10, lineHeight: 1, fontWeight: 400 }}>
            {item.label}
          </span>
      ...
      <div style={{ display: 'flex' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ fontSize: 'var(--doc-text-body)', fontWeight: 300, color: 'var(--gray-500)', whiteSpace: 'nowrap' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    {docs.map((name, i) => (
                      <div key={i} style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
                        ...
                        <span style={{ fontSize: 16, color: 'var(--gray-800)' }}>
                          {name}
                        </span>
                      </div>
                    ))}
...
export const PackingSlipDocumentV9 = React.forwardRef<HTMLDivElement, PackingSlipDocumentProps>(
  function PackingSlipDocumentV9({ data }, ref) {
    ...
    sections.push({
      ...
      content: (
        ...
        >
          ...
          <span className="text-[color:var(--gray-500)]" style={{ fontSize: 13 }}>
            Ordered:{' '}
            <span className="text-[color:var(--gray-800)]" style={{ fontSize: 16, fontWeight: 400 }}>{totalOrdered}</span> units
          </span>
          <span
            style={{ fontSize: 13, color: 'var(--gray-500)' }}
          >
            Shipped:{' '}
            <span style={{ color: 'var(--gray-800)', fontSize: 16, fontWeight: 400 }}>
              {totalShipped}
            </span>{' '}units
            {hasShortage && (
    ...
    return (
      <div ref={ref} data-comp="PackingSlipDocument" data-variant="v9">
        <PaginatedDocument
            ...
            <div data-el="PackingSlipDocument-titleRow" className="flex items-start justify-between" style={{ marginBottom: 8 }}>
              ...
              >
                {metaItems.map((item, i) => (
                  <React.Fragment key={i}>
                    <span
                      className="text-[color:var(--gray-400)] uppercase tracking-[var(--doc-tracking-label)] text-right"
...
export default PackingSlipDocumentV9;
