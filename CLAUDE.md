...
7 documented bug patterns from this project with symptoms, root causes, and fixes.
**Read when debugging**: `Templates/Quote_Build_Auotomate/Known_Pitfalls.md`

Key pitfalls: preview-vs-print CSS divergence, flex grow/shrink unreliability, NONE sentinel inconsistency, useLayoutEffect infinite loop, mixed override detection, collision fingerprint scope, empty initial state.
